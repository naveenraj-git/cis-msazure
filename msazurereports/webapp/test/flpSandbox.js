		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Azure Reports",
									"targetURL": "#convergentreportmsazurereports-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"convergentreportmsazurereports-display": {
								"semanticObject": "convergentreportmsazurereports",
								"action": "display",
								"description": "Azure Reports",
								"title": "Azure Reports",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=convergent.report.msazurereports",
									"url": sap.ui.require.toUrl("convergent/report/msazurereports")
								}
							}
						}
					}
